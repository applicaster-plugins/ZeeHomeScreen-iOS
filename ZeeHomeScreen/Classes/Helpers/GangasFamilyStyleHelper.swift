...
class GangasFamilyStyleHelper {
    ...
    func mappingCellStyles(key: String) {
        ...
        case "HORIZONTAL_LIST_1":
            ...
            self.cellStyle = "Family_Ganges_horizontal_list_1"
        ...
        case "HORIZONTAL_LIST_2":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_2"
            self.iphoneHeight = 167.0
            self.ipadHeight = 218.0
            self.iphoneWidth = 106.0
            self.ipadWidth = 140.0
        ...
        case "HORIZONTAL_LIST_3":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_3"
        ...
        case "HORIZONTAL_LIST_4":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_4"
        ...
        case "HORIZONTAL_LIST_5":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_5"
            self.iphoneHeight = 73.0
            self.ipadHeight = 92.0
            break
        case "HORIZONTAL_LIST_6":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_6"
            self.iphoneHeight = 186.0
            self.ipadHeight = 233.0
            break
        case "HORIZONTAL_LIST_7":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_7"
            self.iphoneHeight = 186.0
            self.ipadHeight = 233.0
            break
        case "HORIZONTAL_LIST_8":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_8"
            self.iphoneHeight = 186.0
            self.ipadHeight = 233.0
            break
        case "HORIZONTAL_LIST_9":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_9"
            self.iphoneHeight = 186.0
            self.ipadHeight = 233.0
            break
        case "HORIZONTAL_LIST_10":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_10"
            self.iphoneHeight = 126.0
            self.ipadHeight = 152.0
            break
        case "HORIZONTAL_LIST_11":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_11"
        ...
        case "HORIZONTAL_LIST_12":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_12"
        ...
        case "HORIZONTAL_LIST_13":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_13"
        ...
        case "HORIZONTAL_LIST_14":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_14"
        ...
        case "HORIZONTAL_LIST_15":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_15"
        ...
        case "HORIZONTAL_LIST_16":
            self.componentStyle = "SectionCompositeViewController"
            self.cellStyle = "Family_Ganges_horizontal_list_16"
        ...
        case "HORIZONTAL_LIST_17":
            ...
            break
        case "HERO_CELL_1":
            self.componentStyle = "Family_Ganges_hero_1"
            self.cellStyle = "Family_Ganges_hero_cell_1"
            self.iphoneHeight = 188.0
            self.ipadHeight = 458.0
            break
        case "HERO_CELL_2":
            self.componentStyle = "Family_Ganges_hero_2"
            self.cellStyle = "Family_Ganges_hero_cell_2"
            self.iphoneHeight = 188.0
            self.ipadHeight = 440.0
            break
        case "HERO_CELL_3":
            self.componentStyle = "Family_Ganges_hero_2"
            self.cellStyle = "Family_Ganges_hero_cell_3"
            self.iphoneHeight = 178.0
            self.ipadHeight = 432.0
            break
        case "HERO_CELL_4":
            self.componentStyle = "Family_Ganges_hero_3"
            self.cellStyle = "Family_Ganges_hero_cell_4"
            self.iphoneHeight = 170.0
            self.ipadHeight = 424.0
            break
        case "HERO_CELL_5":
            self.componentStyle = "Family_Ganges_hero_3"
            self.cellStyle = "Family_Ganges_hero_cell_5"
            self.iphoneHeight = 170.0
            self.ipadHeight = 424.0
            break
        case "BANNER_1":
